...
Zgodnie z metodyką opisaną w poprzednim rozdziale przeprowadzono eksperymenty. Wykonano 120 eksperymentów. Wyniki przedstawione w tabeli \ref{results} zostały uśrednione dla wszystkich przypadków testowych uzyskanych przez zastosowanie cross-validation.
