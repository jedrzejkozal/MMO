...
\begin{titlepage}
	...
	\vspace{1.5cm}
	{\huge\bfseries Zastosowanie Sieci Bayesa do czegośtam \par}
	\vspace{2cm}
...
Celem projektu jest zbadanie zastsowania Sieci Bayesa do automatycznego diagnozowania jakiejś choroby.
